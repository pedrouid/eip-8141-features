...
The account code remains the source of authorization. No protocol pubkey registry is required. This keeps key rotation, large post-quantum public keys, and scheme-specific verification out of persistent protocol state. The table is capped, write-once per digest, and discarded after the transaction.

...
author: Vitalik Buterin (@vbuterin), lightclient (@lightclient), Felix Lange (@fjl), Yoav Weiss (@yoavw), Alex Forshtat (@forshtat), Dror Tirosh (@drortirosh), Shahaf Nacson (@shahafn), Derek Chiang (@derekchiang), Gregory Markou (@GregTheGreek), James Prestwich (@prestwich), Toni Wahrstätter (@nerolation), Pedro Gomes (@pedrouid)
